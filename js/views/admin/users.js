export const renderAuxiliaresTable = (users, routes, filterTerm) => {
...
export const renderAuxiliares = (users, routes, filterTerm) => {
    return `
        ...
        <div class="card" style="padding: 0;" id="auxiliarTableContainer">
            ${renderAuxiliaresTable(users, routes, filterTerm)}
        </div>
    `;
};
